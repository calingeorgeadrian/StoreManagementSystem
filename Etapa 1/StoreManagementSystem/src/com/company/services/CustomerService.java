...
public class CustomerService {
    ...
    public static void changeCustomerLocation(Customer customer){
    ...
    public static void changeCustomerShippingInfo(Customer customer){
        Scanner keyboard = new Scanner(System.in);
        String country, city, zipCode, address;
    ...
    public static void changeCustomerCard(Customer customer){
        Scanner keyboard = new Scanner(System.in);
        String cardNumber;
        ...
        expirationDay = keyboard.nextInt();
        System.out.print("Expiration month: ");
        expirationMonth = keyboard.nextInt();
        System.out.print("Expiration year: ");
        expirationYear = keyboard.nextInt();
        System.out.print("CVC: ");
        cvc = keyboard.nextInt();
        keyboard.nextLine();

        Card creditCard = new Card(cardNumber, new Date(expirationYear, expirationMonth, expirationDay), cvc);
